...
def test_add_evidence_to_dispute(mock_paystack_client):
    ...
    add_evidence_to_dispute("DIS_123", "test@example.com", "John Doe", "12345", "Details")
...
def test_resolve_bvn(mock_paystack_client):
    from app.tools import resolve_bvn
    resolve_bvn("12345678901")
    mock_paystack_client.resolve_bvn.assert_called_once()
