...
class PaystackClient:
    ...
    def fetch_customer(self, customer_code: str):
        ...
        return paystack.Customer.fetch(customer_code=customer_code)

    def update_customer(self, code: str, first_name: str, last_name: str):
        """Update a customer's details using the Paystack API."""
        return paystack.Customer.update(code=code, first_name=first_name, last_name=last_name)
    ...
    def initialize_transaction(self, email: str, amount: int, currency: str):
        ...
        return paystack.Transaction.initialize(email=email, amount=amount, currency=currency)
    ...
    def fetch_transaction(self, transaction_id: int):
        """Fetch a transaction's details from the Paystack API."""
        return paystack.Transaction.fetch(transaction_id=transaction_id)
    ...
    def fetch_plan(self, plan_code: str):
        ...
        return paystack.Plan.fetch(plan_code=plan_code)

    def resolve_account_number(self, account_number: str, bank_code: str):
        """Resolve an account number using the Paystack API."""
        return paystack.Verification.resolve_account_number(account_number=account_number, bank_code=bank_code)
